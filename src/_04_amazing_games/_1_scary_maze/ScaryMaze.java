...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("newmaze.png"));
	...
	public void mouseMoved(MouseEvent e) {
		...
		if (started  && mouseColor == badColor   ) {
	...
	// it)
		if (started && mouseColor == endColor) {
			System.out.println("You won yayyyyyyyy!!!");
				
		JOptionPane.showMessageDialog(null,"You wonnnnnnn yayyyy");
		}
	}
