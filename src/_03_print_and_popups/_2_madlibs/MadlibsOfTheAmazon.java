...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String ad0 = JOptionPane.showInputDialog("Enter an adjective");
		// Get the player to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("Enter any type of liquid");
		// Get the player to enter a body part
		String bones = JOptionPane.showInputDialog("Enter any body part");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog("Enter a verb");
		// Get the player to enter a place
		String location = JOptionPane.showInputDialog("Enter any location");
		...
		String story = 
				"Piranhas are more "+ad0+" during the day, so cross the river at\n"  +
		"night. Piranhas are attracted to fresh "+liquid+" and will most\n"  +
		"likely take a bite out of your "+bones+" if you "+verb+". Whatever\n"  +
